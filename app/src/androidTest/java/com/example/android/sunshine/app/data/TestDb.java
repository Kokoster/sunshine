    ...
    */
    ...
    public void testWeatherTable() {
        ...
        Cursor cursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME,
                null, // all columns
                null, // columns for the where clause
                null, // values for the where clauses
                null, // columns to group by
                null, // columns to filter by row groups
                null // sort order
        );

        assertTrue( "Error: No Records returned from wether query", cursor.moveToFirst() );

        TestUtilities.validateCurrentRecord("Error: Weather Query Validation Failed",
                cursor, weatherTestValues);

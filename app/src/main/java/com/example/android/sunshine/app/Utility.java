...
public class Utility {
    ...
    public static String getWindDirection(float directionDeg) {
        final String DIRECTION = "Direction is ";

        if (directionDeg >= 337.5 || directionDeg < 22.5) {
        ...
        } else if (directionDeg >= 292.5 || directionDeg < 22.5) {
